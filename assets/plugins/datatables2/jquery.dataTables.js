...
(function(h) {
    ...
    function Fa(a) {
        var b = m.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && (c && "<b class='text-yellow'> no data available in table </b>" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {
                sFirst: "First",
                sLast: "Last",
                sNext: "<i class='fa fa-chevron-right text-maroon'></i><i class='fa fa-chevron-right text-maroon'></i>",
                sPrevious: "<i class='fa fa-chevron-left text-maroon'></i><i class='fa fa-chevron-left text-maroon'></i>"
            },
            sEmptyTable: "<b class='text-yellow'> no data available in table </b>",
            sInfo: "<b class='text-blue'><i class='fa fa-check-square-o'></i> showing _START_ to _END_ of _TOTAL_ entries </b>",
            sInfoEmpty: "<b class='text-blue'><i class='fa fa-check-square-o'></i> showing 0 to 0 of 0 entries </b>",
            sInfoFiltered: "<b class='text-red'>(filtered from _MAX_ total entries)</b>",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "<b class='text-blue'><i class='fa fa-check-square-o'></i>&nbsp; show &nbsp; _MENU_ &nbsp; entries </b>",
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: "<b class='text-blue'><i class='fa fa-check-square-o'></i>&nbsp; search : </b>",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "<b class='text-red'> no matching records found </b>"
        },
